    ...
    <div className="relative flex-grow">
      ...
      <Image src={'/assets/Frame 18.png'} alt='trackage logo' width={150} height={150} className="md:hidden" />
        <nav className="space-x-4">
          <Link href="/admindashboard" className="text-lg md:text-2xl text-blue-400 font-bold hover:underline">Admin</Link>
          <Link href="/dashboard" className="text-lg md:text-2xl text-blue-400 font-bold hover:underline">Member</Link>
        </nav>
      </header>
      <main className="px-10 md:container mx-auto flex flex-col items-center justify-center flex-grow">

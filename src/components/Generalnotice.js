...
<div className="" role="alert">
  <h1 className='text-lg md:text-2xl font-semibold text-center'>Alert and Notification</h1>
  <form onSubmit={handleSubmit} className="mt-4 mx-auto">
    <div className="hidden md:flex-row items-center gap-6">
      <p className="text-lg md:text-xl">Current Notification Type</p>
      <div className="bg-blue-100 px-4 py-2 text-black border rounded">
        <p className='text-sm'>Push Notification</p>
      </div>
    </div>
          
    <div className="w-full mt:4 md:w-3/4 md:mt-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
        <div>
          <label htmlFor="setting1" className='text-lg'>Change Notification Type</label>
          <select id="setting1" name="setting1" className="border bg-blue-100 rounded p-1 w-full mt-2">
        ...
        <div>
          ...
          <select id="setting2" name="setting2" className="border bg-blue-100 rounded p-1 w-full mt-2">
            <option value="option1" className='text-sm'>Push Notification</option>
            <option value="option2" className='text-sm'>SMS</option>
            <option value="option2" className='text-sm'>Email</option>
          </select>
        ...
        <div className='mt-4 md:mt-8'>
          ...
          <select id="setting3" name="setting3" className="border bg-blue-100 rounded p-1 w-full mt-1">
            <option value="option1" className='text-sm'>Push Notification</option>
            <option value="option2" className='text-sm'>SMS</option>
            <option value="option2" className='text-sm'>Email</option>
          </select>
        ...
        <div className='mt-4 md:mt-8'>
          ...
          <select id="setting4" name="setting4" className="border bg-blue-100 rounded p-1 w-full mt-1">
            <option value="option1" className='text-sm'>Push Notification</option>
            <option value="option2" className='text-sm'>SMS</option>
            <option value="option2" className='text-sm'>Email</option>
          </select>
